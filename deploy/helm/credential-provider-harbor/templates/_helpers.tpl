...
- name: RKE2_CONFIG_DROP_IN_PATH
  value: {{ .Values.kubelet.rke2ConfigDropInPath | quote }}
- name: KUBELET_DEFAULTS_PATH
  value: {{ .Values.kubelet.kubeletDefaultsPath | quote }}
- name: MICROK8S_KUBELET_ARGS_PATH
  value: {{ .Values.kubelet.microk8sArgsPath | quote }}
{{- end }}
