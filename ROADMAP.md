...
See [RELEASES.md](RELEASES.md) for how a release is cut, and [GitHub Releases](https://github.com/container-registry/harbor-workload-identity-federation/releases) for published versions.
