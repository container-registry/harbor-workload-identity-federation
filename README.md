...
This repository covers the Kubernetes side: the credential provider, the installer, the chart, and per-distribution guides. [DOCS-MIGRATION.md](DOCS-MIGRATION.md) tracks which of the reference material below is moving to the documentation site.
